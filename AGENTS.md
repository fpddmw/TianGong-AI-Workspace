...
- `src/tiangong_ai_workspace/agents/`:
  ...
  - `citation_agent.py`: Shared citation-analysis helpers (Supabase DOI fulltext + PDF/Mineru fallback + rubric scoring) reused by the CLI and agents for `citation-study`/journal-band flows.
